            ...
            if(menuItems.isNotEmpty()) {
                Box {
                    DropdownMenu(
                        ...
                        menuItems.forEachIndexed { index, dropdownItems ->
                            Row(
                                verticalAlignment = Alignment.CenterVertically,
                                modifier = Modifier
                                ...
                                Icon(
                                    imageVector = dropdownItems.icon,
                                    contentDescription = dropdownItems.title
                                )
                                Spacer(modifier = Modifier.width(8.dp))
                                Text(text = dropdownItems.title)
                            }
                        }
                    }
                    IconButton(onClick = { isDropDownOpen = true }) {
                        Icon(
                            ...
                            contentDescription = stringResource(id = R.string.open_out),
